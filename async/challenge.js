...
const API_KEY = "44031897553789987945x120617";

const whereAmI = function (lat, lon) {
  fetch(`https://geocode.xyz/${lat},${lon}?json=1`).then((res) => {
    if (!res.ok) {
...
//   return fetch(`https://geocode.xyz/${lat},${lon}?json=1`)
...
// };
// const whereAmI = function (lat, lon) {
//   const myLocation = fetchData(lat, lon);
// };

// const locationsPromise = fetchData(52.508, 13.381);
// locationsPromise.then(function (locations) {
//   console.log("locations", locations);
//   // Call whereAmI here after locationsPromise has resolved
//   whereAmI(52.508, 13.381);
// });

// console.log("locationsPromise", locationsPromise);
